...
namespace AlgoVisualizer {
	...
	public:
		...
		{
			InitializeComponent();
			targetBox = gcnew System::Windows::Forms::TextBox();
			// Set properties for targetBox if needed
			this->Controls->Add(targetBox); // Add targetBox to the form's controls
			//
	...
	private: System::Windows::Forms::TextBox^ inputBox; System::Windows::Forms::TextBox^ targetBox;
	protected:
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->binarySearchBtn = (gcnew System::Windows::Forms::Button());
			this->SuspendLayout();
			// 
			// inputBox
			// 
			...
			//
			this->binarySearchBtn->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12));
			this->binarySearchBtn->Location = System::Drawing::Point(600, 403);
			this->binarySearchBtn->Name = L"binarySearchBtn";
			this->binarySearchBtn->Size = System::Drawing::Size(158, 42);
			this->binarySearchBtn->TabIndex = 7;
			this->binarySearchBtn->Text = L"Binary Search";
			this->binarySearchBtn->UseVisualStyleBackColor = true;
			this->binarySearchBtn->Click += gcnew System::EventHandler(this, &MyForm::Click_btn);
...
#pragma endregion
	...
	private: System::Void Click_btn(System::Object^ sender, System::EventArgs^ e) {
		...
		if (((System::Windows::Forms::Button^)sender)->Text->ToString() == "Binary Search") {
			this->Hide(); // Hide the current form
			form2->ShowDialog(); // Show the visualization form
			this->Show(); // Show the current form again after visualization is closed
		}
		else {
			form2->ShowDialog(); // Show other forms directly
		}
	}
